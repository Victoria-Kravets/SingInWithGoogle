...
public struct Constants {
    ...
    static let ConfirmEditingEventAlertMessage = NSLocalizedString(
        "All members of the group will be notified", comment: "")
    static func ConfirmEditingEventAlertTitle(_ eventType: String) -> String {
        return String(format: NSLocalizedString(
            "Are you sure you want to cancel this %@?", comment: ""), eventType)
    }
    static let ConfirmLogOutAlertMessage = NSLocalizedString("Are you sure you want to log out?",
                                                             comment: "")
    static let UnknownErrorDescription = NSLocalizedString("Unknown Error", comment: "")
    static let LostInternetConectionAlertMessage = NSLocalizedString(
        "Please check your internet connection and try again", comment: "")
    static let IncorrectDateAlertMessage = NSLocalizedString(
        "End time can't precede the start time", comment: "")
    static let SameDateAlertMessage = NSLocalizedString("The end time can't be the same as the start time",
                                                        comment: "")
    ...
    static let CancelTestAlertTitle = NSLocalizedString(
        "Are you sure you want to cancel this test?", comment: "")
    static let CancelTestAlertMessage = NSLocalizedString(
        "All results will be lost and you'll have to take the test again", comment: "")
    ...
    static let AboutAppText = NSLocalizedString("PROVENG helps each user to learn" +
        " English more effective. It offers users a placement test to determine their " +
        "language skill level.\n\nYou always know where and when will be next lesson or" +
        " workshop. With PROVENG Calendar your timetable is always at hand.\n\nPROVENG is" +
        " reliable assistant for English teacher. Discover how to learn English easier " +
        "with PROVENG.\n\nP.S. Gene Galanter & Nick Antonov already use PROVENG for " +
        "studying English.\n\nDeveloped by a team of interns.", comment: "")
    static let PrivacyText = NSLocalizedString("This app is aimed at people over " +
        ...
        " you wanted.\n•  Improve the app over time.\n\nPROVENG includes measuring tools. " +
        "We want to learn how you use the app so we can improve it in future updates. " +
        "The data is seen only us. We measure how you use this app.\n\nFrom time to time, " +
        "we might contact you via Message Within app.\n\nThe security of your personal" +
        " information is extremely important. We take the following precautions to make sure" +
        " it cannot be accessed or altered:\n•  Data encrypted in storage\n•  Industry " +
        "standard Internal security protocols", comment: "")
    static let TermsText = NSLocalizedString("GENERAL\nPlease read these Terms of Service" +
        " carefully before using the PROVENG Application (next Application). Your " +
        "access to and use of the Application is conditioned on your acceptance of and " +
        "compliance with these Terms. These Terms apply to all visitors, users and others " +
        "who access or use the Application. By accessing or using the Application you agree" +
        " to be bound by these Terms.\n\nDEFINITIONS\nThe \"Application\" shall mean the" +
        " software provided by Provectus to offer services related to PROVENG to be used " +
        "on iOS, Android devices and any upgrades from time to time and any other software " +
        "or documentation which enables the use of the Application.\n\nDATA PROTECTION\nAny" +
        " personal information you supply to PROVENG when using the Application will be used" +
        " in accordance with Privacy Policy.\n\nRPOPRIETARY RIGHTS AND LICENCE\nAll " +
        "trademarks, copyrighting, database rights and other intellectual property rights " +
        "of any nature in the Application together with the underlying software code are" +
        " owned directly by PROVENG. PROVENG hereby grants you a worldwide, non-exclusive," +
        " royalty-free revocable licence to use the Application for personal use in " +
        "accordance with these appterms.\n\nLINKS TO OTHER WEB SITES\nOur Application" +
        " may contain links to third-party web sites or services that are not owned or " +
        "controlled by PROVENG. PROVENG has no control over, and doesn't take responsibility" +
        " for the content, privacy policies, or practices of any third party web sites " +
        "or services.  We strongly advise you to read the terms and conditions and " +
        ...
        " discretion, to modify or replace these Terms at any time. By continuing to access or" +
    ...
    static let EmptyFeedText = NSLocalizedString(
        "You'll be added to the group soon", comment: "")
    // MARK: Tests
    static let PreviewTestDescription = NSLocalizedString("Find out what your level" +
        " of English ability is by completing the following placement test.\n\n",
                                                          comment: "")
    ...
    static func PreviewTestText1(_ questionsCount: Int) -> String {
        let text = String(format: NSLocalizedString(
            "\n\n●  The test contains %i single-answer questions",
            comment: ""), questionsCount)
        return text
    }
    static func PreviewTestText2(_ minutes: Int) -> String {
        let text = String(format: NSLocalizedString(
            "\n\n●  You will have %i minute(s) to complete the test", comment: ""),
                          minutes)
        return text
    }
    static let PreviewTestText3 = NSLocalizedString("\n\n●  You’ll receive your score" +
        " and have to wait before the teacher adds you to the group that would best fit" +
        " your level", comment: "")

    static let PreviewRegularTestText3 = NSLocalizedString("\n\n●  If you cancel in " +
        "the middle of the test you will lose your results and will have to start over.", comment: "")
    ...
    static func ResultMarkTestText(_ mark: Int, weight: Int) -> String {
        let text = String(format: NSLocalizedString("Correct answers: %i/%i",
                                                    comment: ""), mark, weight)
        return text
    }
    // MARK: Design
    static let errorColor = UIColor.red
    static let regularFont = UIFont.systemFont(ofSize: 17, weight: UIFont.Weight.regular)
    static let lightFont = UIFont.systemFont(ofSize: 17, weight: UIFont.Weight.light)
    // MARK: Keys
